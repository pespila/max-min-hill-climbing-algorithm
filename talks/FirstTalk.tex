...
\section{Graph theory}
	\subsection{Bayesian Network}
		\begin{frame}
			\frametitle{Directed Acyclic Graphs \& Bayesian Networks}
				$
	...
	\subsection{Blocked paths}
		\begin{frame}
			\frametitle{Blocked paths}
			\begin{block}{Define four sets}
				\begin{center}
					Let $Z_{1}$, $Z_{2}$, $Z_{3}$ and $Z_{4}$ denote sets with:
					\begin{eqnarray}
						Z_{1} &=& \{ \emptyset \} \notag \\
						Z_{2} &=& \{W\} \notag \\
						Z_{3} &=& \{R, V\} \notag \\
...
\section{Statistics}
	...
	\subsection{$\chi^{2}$ and hypothesis testing}
		\begin{center}
			\begin{frame}
				\begin{center}
					\begin{figure}
						\includegraphics[scale=0.4,angle=270]{img/chi}
					\end{figure}
				\end{center}
			\end{frame}
		\end{center}
...
\section{The algorithm}
	...
	\subsection{Recall the first example}
		\begin{frame}
			\begin{small}
				\begin{psmatrix}[emnode=r,colsep=0.5cm,rowsep=0.6cm,mnodesize=2cm]
					[name=Tdiff]
